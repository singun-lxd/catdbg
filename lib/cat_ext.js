...
const local = {
    get: async function(siteKey, key, defValue) {
        return localStorage.getItem(siteKey + '_' + key) || defValue;
    },
...
async function req(url, opt) {
    try {
        ...
        if (!returnBuffer) {
            ...
            return { code: resp.status, headers: resHeader, content: arrayBufferToBase64(data) };
